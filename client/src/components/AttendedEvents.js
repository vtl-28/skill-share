...
const AttendedEvents = () => {
  ...
  return (
    <div>
      {
        data.length > 0 ? displayAttendedTalks(data) : (<div className="p-4 mt-2 text-center bg-slate-200 rounded-md">
                    <div className='bg-white p-4 flex flex-col'>
                        <InfoIcon className='self-center text-2xl'/>
                        <p className='mt-2'>You have not registered for any talks. Talks you have registered for will appear here</p>
                    </div>
                </div>)
      }
    </div>
