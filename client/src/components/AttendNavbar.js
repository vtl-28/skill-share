    ...
    <div className='remove-overflow'>
        ...
        <Container>
          ...
          <Navbar.Collapse id="navbarScroll" className="flex-row-reverse">
            <Nav
              className="flex justify-between md:w-2/3 xs:w-full"
         ...
         <div className='flex align-items-center'>
            <Button rightIcon={<FaShareSquare />} variant='outline' colorScheme='teal' size='lg' className=' hover:text-white'>Share</Button>
         </div>
        <div className='flex align-items-center'>
         {
             ids.includes(user._id) ? 
             <Button bgColor='#F64060' className=" text-white" onClick={(e) => cancel(e)} size='lg'>Cancel Talk</Button> :
             <Button bgColor='#F64060' className=" text-white" onClick={(e) => book(e)} size='lg'>Attend Talk</Button>
         }
