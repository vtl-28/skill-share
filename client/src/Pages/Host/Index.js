...
const Index = () => {
  ...
  const { _id, name, email, profession, pic, about } = data;
  return (
    <div>
      <DashboardNavbar />
        ...
        >
          <Flex width={["100%", "100%", "55%", "60%"]} mb={["6"]}>
            <img
              src={pic}
              alt="logo"
              className="object-fill w-full xs:h-50 rounded-md"
            />
          </Flex>
          <Flex direction="column" width={["100%", "100%", "40%", "33%"]}>
            <h1 className="text-4xl font-bold tracking-widest leading-5">
              {name}
            </h1>
            ...
            <div className="flex mt-3">
              ...
              <h3 className="ml-4 tracking-widest leading-5">
                Organized by {name}
              </h3>
            </div>
            <div className="flex lg:mt-40 xl:mt-48 xs:w-1/2 sm:w-1/3 md:w-2/3 justify-between xs:mt-5 md:mt-14">
              ...
              <a
                href="#"
                className="mx-1 flex align-items-center justify-center text-xl"
              >
                <FaFacebookSquare />
              </a>
              <a
